                ...
                <div class="card-body">
                    <form action="{{ route('admin.role.update', [$role->id]) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" id="name" aria-describedby="roleHelp" placeholder="Enter role" value="{{ $role->name }}">
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select form-control{{ $errors->has('department_id') ? ' is-invalid' : '' }}" name="department_id">
                                <option selected value="{{ $role->department->id }}">{{ $role->department->name }}</option>
